    ...
    private final WeatherRequest.Stub mWeatherRequestImpl =
        new WeatherRequest.Stub() {
            ...
            public void getCurrentWeather(final String location,
				...
				List<WeatherData> dataList = getWeatherResults(location);
				...
				if (dataList != null && dataList.size()>0)
				{
					...
					//obtain first element from the dataList
					weatherData = dataList.get(0);
				}else{
					
					System.out.println("No Wheater Data found");
