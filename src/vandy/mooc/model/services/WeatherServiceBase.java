...
public class WeatherServiceBase 
     ...
     */
    private final String mAppid = "0888d6d73eeb6588a5b5da08f4d32bb9";
    ...
    protected List<WeatherData> getWeatherResults(String location) {
        Log.d(TAG,
        	...
        	// Create a List that will return the WeatherData obtained
     		...
     		List<WeatherData> jsonWeathers = null;
     		...
     		try
     		{
     			...
     			final URL url = new URL(mWeatherServiceURL + encodedLocation);
     		...
     		if (jsonWeathers != null && jsonWeathers.size() > 0)
     		{
     			...
     			for (WeatherData jsonWeather : jsonWeathers)
     			{

     				if (jsonWeather.getWeathers().size() == 0)
     				{
     				...
     				returnList.add(new WeatherData(jsonWeather.getName(),
     						jsonWeather.getDate(),jsonWeather.getCod(),
     						jsonWeather.getSys(),jsonWeather.getMain(),
     						jsonWeather.getWind(),
     						jsonWeather.getWeathers()));
