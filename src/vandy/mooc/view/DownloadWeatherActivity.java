...
public class DownloadWeatherActivity
    ...
    public void displayResults(WeatherData weatherData,
        ...
        if (weatherData == null) 
            ...
            if (intent.resolveActivity(getPackageManager()) != null && weatherData!=null
            		&& weatherData.getName()!=null && weatherData.getWeathers().size()>0)
                ...
                // Show error message to user.
                Utils.showToast(this,
                                "Not found to display Weather Data");
        }
    }
}
